     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" id="shugang" style=" visibility:hidden;" /><img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" id="fanhui" style=" visibility:hidden;" />&nbsp;</td>
            </tr>
        </table>
                        ...
                        <asp:TemplateField HeaderText="文件主题">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "FileView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") + "&per=chuanyuewenjian" %>'><%# DataBinder.Eval(Container.DataItem, "TitleStr")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                       <asp:BoundField DataField="Zihao" HeaderText="字号" >
...
<script type="text/javascript">
    ...
    if (str.toString().indexOf("fanhui=true") > 0) {
        document.getElementById("shugang").style.visibility = "visible";
        document.getElementById("fanhui").style.visibility = "visible";
    }
</script>
