        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="../images/Button/GetMail.jpg"
                        ImageAlign="AbsMiddle" OnClick="ImageButton5_Click" />
                    &nbsp;
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg"
                        ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="window.location.reload()" src="../images/Button/Btnrefresh.jpg" />&nbsp;<%--<img
                    ...
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="邮件主题">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "NetEmailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "EmailTitle")%></asp:HyperLink>
                                </ItemTemplate>
