            ...
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<img src="../images/Button/JianGe.jpg" />&nbsp;<img class="HerCss" onclick="window.location.reload()"
                        src="../images/Button/Btnrefresh.jpg" />&nbsp;
                    <input type="image" id="fanhui" class="HerCss" onclick="javascript:alert(1);history.go(-1);"
                        src="../images/Button/BtnExit.jpg" /><%--<asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/Button/BtnExit.jpg" />--%>&nbsp;
                </td>
            </tr>
            <tr>
