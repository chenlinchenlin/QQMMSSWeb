<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Common.aspx.cs" Inherits="SystemManage_common" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;共有参数
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="window.location.reload()" src="../images/Button/Btnrefresh.jpg" /><!--<img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />-->&nbsp;</td>
            </tr>
        </table>
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CSort" HeaderText="排序" >
                         ...
                         <asp:BoundField DataField="CDescription" HeaderText="类型描述" >
                        </asp:BoundField>     
