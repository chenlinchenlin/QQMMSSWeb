     ...
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=minzu&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox13').value=wName;}"
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
                婚姻状况：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
            <asp:RadioButtonList runat="server" ID="rbl_maritalState" RepeatDirection="Horizontal">
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
                政治面貌：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
            <asp:RadioButtonList runat="server" ID="rbl_polityType" RepeatDirection="Horizontal">
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=xueli&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox19').value=wName;}"
                    src="../images/Button/search.gif" /></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=zhicheng&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox20').value=wName;}"
                    src="../images/Button/search.gif" /></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
