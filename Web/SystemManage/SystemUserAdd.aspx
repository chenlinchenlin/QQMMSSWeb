    ...
    <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox ID="TextBox2" TextMode="Password" runat="server" Width="350px" Height="23px"></asp:TextBox>
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
                所属部门：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox ID="TextBox5" onfocus="this.blur()" runat="server" Width="350px"></asp:TextBox>
        ...
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
                职位：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                <asp:TextBox ID="TextBox7" onfocus="this.blur()" runat="server" Width="350px"></asp:TextBox>
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=zhiwei&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox7').value=wName;}"
                    src="../images/Button/search.gif" /></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">组别：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff"><asp:TextBox ID="txt_gn" onfocus="this.blur()" runat="server" Width="350px"></asp:TextBox>
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=zubie&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('txt_gn').value=wName;}"
                    src="../images/Button/search.gif" /></td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
                在岗状态：</td>
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:RadioButtonList runat="server" ID="rbl_wstate" RepeatDirection="Horizontal">
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
               <asp:RadioButtonList runat="server" ID="rbl_sex" RepeatDirection="Horizontal">
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img onclick="WdatePicker({el:'<%=TextBox12.ClientID %>'})" src="../Controls/My97DatePicker/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
                </td>
        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img onclick="WdatePicker({el:'<%=TextBox23.ClientID %>'})" src="../Controls/My97DatePicker/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
                </td>
                        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <img onclick="WdatePicker({el:'<%=TextBox24.ClientID %>'})" src="../Controls/My97DatePicker/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle">
                </td>
                        </tr>
        <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">
