...
<html>
  ...
  <script type="text/javascript" language="javascript">
      ...
      onload = function () {
          ...
          var start = cookies.indexOf("goBackNo");
          if (start != -1) {
              var end = cookies.indexOf("=", start);
              if (end != -1) {
                  cookies = cookies.substring(end+1);
                  if (cookies == "-2") {
                      document.getElementById("img_gb").onclick = function () {
                          window.history.go(-3);
                      }
                  }
              }
     ...
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <img alt="" src="../images/Button/JianGe.jpg" />&nbsp;
                    <img id="img_gb" alt="" class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />&nbsp;</td>
            </tr>
            <tr>
