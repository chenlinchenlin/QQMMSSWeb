...
<body>
    ...
    <div>
        <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <img class="HerCss" onclick="javascript:history.go(-1);return false;" src="../images/Button/BtnExit.jpg" />&nbsp;
                </td>
            </tr>
            <tr>
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3">公告类别：</td>
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff"><asp:TextBox ID="txt_nt" onfocus="this.blur()" runat="server" Width="350px"></asp:TextBox>
                <img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?type=noticetype&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('txt_nt').value=wName;}"
            ...
            <tr>
                ...
                <td style="padding-left: 5px; background-color: #ffffff">
                    <asp:TextBox ID="TextBox2" runat="server" onfocus="this.blur()" Width="350px"></asp:TextBox>
