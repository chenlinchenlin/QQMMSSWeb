                                ...
                                Height="20px" Width="60px"></asp:TextBox><img class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectCondition.aspx?TableName=ERPLanEmail&LieName=EmailState&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox3').value=wName;}"
                                    src="../images/Button/search.gif" /><asp:ImageButton ID="ImageButton4" runat="server"
                                        ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg" OnClick="ImageButton4_Click" />&nbsp;<asp:ImageButton
                                            ID="ImageButton3" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnDel.jpg"
                                            OnClick="ImageButton3_Click" OnClientClick="javascript:return CheckDel();" />&nbsp;<asp:ImageButton
                                                ID="ImageButton2" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnReport.jpg"
                                                OnClick="ImageButton2_Click" />
                    <img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="window.location.reload()"
                        src="../images/Button/Btnrefresh.jpg" />&nbsp;<%--<img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />--%><%--<asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/Button/BtnExit.jpg" />--%>&nbsp;
                </td>
            </tr>
        </table>
                    ...
                    <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="邮件主题">
                                <ItemTemplate>
                                    &nbsp;
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "EmailView.aspx?fromurl=0&ID="+ DataBinder.Eval(Container.DataItem, "ID")%>  '><%# DataBinder.Eval(Container.DataItem, "EmailTitle")%></asp:HyperLink>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Width="100px" HeaderText="接收人" SortExpression="ToUser">
                                <ItemTemplate>
                                    <a>
                                        <%# Eval("ToUser").ToString().Length > 5 ? Eval("ToUser").ToString().Substring(0, 5) + "..." : Eval("ToUser").ToString()%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
