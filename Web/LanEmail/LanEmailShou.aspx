     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="window.location.reload()" src="../images/Button/Btnrefresh.jpg" />&nbsp;<%--<img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />--%><%--<asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/images/Button/BtnExit.jpg" />--%>&nbsp;</td>
            </tr>
        </table>
