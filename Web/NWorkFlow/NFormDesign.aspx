...
else if(str=="108")
{
    ...
    if(document.getElementById("TextBox18").value.length>0){
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'"  alt="'+document.getElementById("TextBox18").value+'" type="text" value="宏控件-发文字号" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
    document.getElementById("TextBox17").value=document.getElementById("TextBox17").value+"|"+"Text"+cValue+"_"+document.getElementById("TextBox18").value;//系统控件自动计数
    }else{alert('中文字段名称不可为空！');}
}

else if(str=="17")
{
    URL="NAddListView.aspx";
    window.showModalDialog(URL,self,"edge:raised;scroll:0;status:0;help:0;resizable:1;dialogWidth:420px;dialogHeight:470px;dialogTop:350px;dialogLeft:550px");
}

else if(str=="19")
{
    if(document.getElementById("TextBox19").value.length>0){
    eWebEditor1.insertHTML('<input id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox19").value+'"  type="text"  style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000;display: none"/><iframe id="eWebEditor1" frameborder="0"  height="720" scrolling="no" src="../eWebEditor/ewebeditor.htm?id=Text'+cValue+'&style=mini" width="100%"></iframe> ');
        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td style="width: 208px; height: 25px; background-color: #D6E2F3; text-align: center;
                    ...
                    中文名：<asp:TextBox ID="TextBox19" runat="server" Width="90px"></asp:TextBox><br />
                    <hr />
                    ...
                    <input id="Button17" onclick="formset(17)" style="width: 60px" type="button" value="列表控件" />
                    <hr />
                    <strong>宏控件</strong>
                    <br />
                    <hr />
                    ...
                    <input id="Button18" onclick="formset(108)" style="width: 60px" type="button" value="发文字号" />
                    中文名：<asp:TextBox ID="TextBox18" runat="server" Width="90px"></asp:TextBox><br />
                    <hr />
                    <strong>&nbsp;印章控件
                        <br />
                    </strong>
