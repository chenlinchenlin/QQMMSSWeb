    ...
    <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">            
        ...
        <tr>
            ...
            <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <asp:Button ID="Button3" runat="server" Text="保存并指定其他节点" OnClick="Button3_Click" Width="144px" />
                <asp:Button ID="Button4" runat="server" Text="保存并不通过" OnClick="Button4_Click" Width="90px" /></td>
        </tr>
        <tr>
            <td align="right" colspan="2" style="height: 25px; background-color: #D6E2F3; text-align: center">
