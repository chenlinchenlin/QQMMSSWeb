<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NWorkFlowNodeUserModify.aspx.cs" Inherits="NWorkFlowNodeUserModify" %>
<html>
	<head>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="txtNodeSerils" runat="server" Width="350px" Enabled="false"></asp:TextBox></td></tr>
	<tr>
	<td style="width: 170px; height: 25px; background-color: #cccccc" align="right">
		节点名称：
	</td>
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="txtNodeName" runat="server" Width="350px" Enabled="false"></asp:TextBox></td></tr>
	<tr>
	<td style="width: 170px; height: 25px; background-color: #cccccc" align="right">
		节点位置：
	</td>
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList1" runat="server" Width="350px" Enabled="false">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
		<asp:TextBox id="txtNextNode" runat="server" Width="350px" Enabled="false"></asp:TextBox>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList2" runat="server" Width="350px" Enabled="false">
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList3" runat="server" Width="350px" Enabled="false">
            <asp:ListItem>是</asp:ListItem>
            <asp:ListItem>否</asp:ListItem>
        </asp:DropDownList></td></tr>
	<tr>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList4" runat="server" Width="350px" Enabled="false">
            <asp:ListItem>是</asp:ListItem>
            <asp:ListItem>否</asp:ListItem>
        </asp:DropDownList></td></tr>
	<tr>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList5" runat="server" Width="350px" Enabled="false">
            <asp:ListItem>是</asp:ListItem>
            <asp:ListItem>否</asp:ListItem>
        </asp:DropDownList></td></tr>
	<tr>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        转入此审批节点后，<asp:TextBox ID="txtJieShuHours" runat="server" Width="49px" Enabled="false">72</asp:TextBox>小时未处理，自动发送催办提醒！<asp:RequiredFieldValidator
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        <asp:DropDownList ID="DropDownList6" runat="server" Width="350px" Enabled="false">
