<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectGroup.aspx.cs" Inherits="Main_SelectGroup" %>
...
<body style="text-align: center">
    ...
    <div>
        <table style="width: 100%; height: 20px;" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="right" style="background-image: url(../images/show_02.gif); border-bottom: #006633 1px dashed;
                    text-align: left;">
    ...
    <table width="100%" align="left">
        <tr>
            <td align="left">
                <div style="overflow: auto; width: 340px; height: 330px; padding-bottom: 3px; padding-top: 0px;
