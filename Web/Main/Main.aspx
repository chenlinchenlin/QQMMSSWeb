...
<body>
    <div id="divTop" style="height: 50px; background-image: url('../images/topbg.jpg');">
        <table style="width: 100%;">
            <tr>
                <td rowspan="2">
                    <img src="../images/shenjititle.png" style="width: 467px; height: 50px;" />
                </td>
            </tr>
        </table>
    </div>
    <div>
        <script type="text/javascript">
          ...
          ({
            ...
            items:
             [
                         { xtype: 'label',
                             html: '<div><img style="width: 467px; height:50px;" src="../images/shenjititle.png" /></div>'
                         }, "->",
                         {                                          
                          xtype: 'tbbutton',
                          text: '当前用户： <font color="black"><%= ZWL.Common.PublicMethod.GetSessionValue("UserName")%></font>',
                          cls: 'x-btn-text-icon',
       ...
       var panel_toolbar = new Ext.Panel
        ...
        ({
            activeTab: 0, autoWidth: true, autoScroll: true, border: true, frame: true, id: "TabPanelID", enableTabScroll: false,
            items:
            [
                {
