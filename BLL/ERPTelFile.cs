...
namespace ZWL.BLL
{
    ...
    public class ERPTelFile
    {
        ...
        public ERPTelFile(int ID)
        {
            ...
            strSql.Append("select ID,TitleStr,FromUser,TimeStr,FileType,ToUser,YiJieShouRen,ContentStr,FuJianStr,ChuanYueYiJian,QianShouHouIDList,ChuanYueHouIDList1,Zihao ");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Zihao = ds.Tables[0].Rows[0]["Zihao"].ToString();
            }
        }
        /// <summary>
        /// 是否存在该记录
        ...
        public int Add()
        {
            ...
            strSql.Append("TitleStr,FromUser,TimeStr,FileType,ToUser,YiJieShouRen,ContentStr,FuJianStr,ChuanYueYiJian,QianShouHouIDList,ChuanYueHouIDList1,Zihao)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,TitleStr,FromUser,TimeStr,FileType,ToUser,YiJieShouRen,ContentStr,FuJianStr,ChuanYueYiJian,QianShouHouIDList,ChuanYueHouIDList1,Zihao ");
            strSql.Append(" FROM ERPTelFile ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
