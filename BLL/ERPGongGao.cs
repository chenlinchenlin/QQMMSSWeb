...
namespace ZWL.BLL
{
    ...
    public class ERPGongGao
    {
        ...
        public int Add()
        {
            ...
            strSql.Append("TitleStr,UserName,UserBuMen,FuJian,ContentStr,TypeStr,NoticeType)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,TitleStr,UserName,UserBuMen,FuJian,ContentStr,TypeStr,TimeStr,NoticeType ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select [ID],[TitleStr],[TimeStr],[UserName],[UserBuMen],[FuJian],[ContentStr],[TypeStr],[NoticeType] ");
            strSql.Append(" FROM ERPGongGao ");
            if (strWhere.Trim() != "")
            {
